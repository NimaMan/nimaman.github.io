...
As of **April 14, 2026**, the old order still stands. The IMF's [COFER data brief published on March 27, 2026](https://data.imf.org/en/news/imf%20data%20brief%20march%2027) shows that in the fourth quarter of 2025 the dollar still accounted for **56.77%** of disclosed global foreign exchange reserves. In the BIS's [2025 Triennial Survey](https://www.bis.org/statistics/rpfx25.htm), the dollar was on one side of **89.2%** of foreign-exchange trades in April 2025. SWIFT's [Global Currency Tracker for February 2026](https://www.swift.com/swift-resource/252544/download) shows the dollar at **49.68%** of global payment value in January 2026, or **58.83%** when payments within the eurozone are excluded.
...
The current U.S.-Iran war has now pushed the question of payment control out of theory and into geopolitical reality. On **April 14, 2026**, AP reported that the United States had declared a [blockade of Iranian ports](https://www.centcom.mil/MEDIA/PRESS-RELEASES/Press-Release-View/Article/4457255/us-to-blockade-ships-entering-or-exiting-iranian-ports/) while the showdown over the Strait of Hormuz continued to threaten the regional ceasefire and deepen the war's economic fallout. But the more interesting monetary development is not only the blockade itself. It is what has happened to settlement around the chokepoint.

Reporting from late March and early April 2026 filled in the mechanism. [Lloyd's List](https://www.lloydslist.com/LL1156720/Tehrans-toll-booth-system-is-now-controlling-Hormuz-traffic) first documented a de facto toll-booth regime in the Strait of Hormuz — vessels vetted and granted approved transit through Iranian waters — with at least two ships reported to have paid in **yuan** through intermediaries outside the SWIFT system. [AP](https://www.pbs.org/newshour/world/irans-proposal-to-collect-tolls-in-the-strait-of-hormuz-violates-trade-norms) reported on **April 8, 2026** that Iran was demanding the right to collect tolls in the strait as part of its proposal for ending the war, and [Bloomberg Law](https://news.bloomberglaw.com/crypto/irans-sanctions-busting-crypto-ambitions-grow-on-toll-payments) reported days later that Tehran had signaled payments in **digital currency** should form part of such a system — for an obvious reason: tokens are harder to confiscate under sanctions than value moving through conventional channels.
...
The total value of stablecoins in circulation sits near [**$313 billion**](https://www.coingecko.com/en/categories/stablecoins), having crossed a record [**$320 billion**](https://news.bitcoin.com/stablecoin-market-cap-hits-all-time-high-of-318-6b-eyes-320-billion-milestone/) in April 2026. That is a claim on dollars larger than the foreign-exchange reserves of all but a handful of the world's central banks. At this scale, it did not exist a decade ago.

The concentration is heavy. Tether's USDT accounts for roughly [**$186 billion**](https://www.coingecko.com/en/categories/stablecoins), close to **58%** of the market, against about [**$77 billion**](https://www.coingecko.com/en/categories/stablecoins) — some **24%** — for Circle's USDC. Two issuers carry more than four-fifths of the float.

And it is, overwhelmingly, a dollar instrument. By the European Central Bank's count, dollar-pegged tokens make up roughly [**99%**](https://www.ecb.europa.eu/press/financial-stability-publications/fsr/focus/2025/html/ecb.fsrbox202511_05~63636227b4.en.html) of stablecoin supply; euro-denominated tokens are under **1%**. The stablecoin economy is not an escape from the dollar. It is the dollar, re-issued on rails its official custodians do not control.

The flows are the point. On-chain stablecoin transfers reached about [**$33 trillion**](https://www.bloomberg.com/news/articles/2026-01-08/stablecoin-transactions-rose-to-record-33-trillion-led-by-usdc) in 2025, up roughly **72%** in a year. On a wider measure, a16z puts raw transfer volume nearer [**$46 trillion**](https://a16zcrypto.com/posts/article/state-of-crypto-report-2025/) over the trailing twelve months — more than Visa's roughly **$16.7 trillion** in card payments.

That comparison deserves an honest qualification. Strip out trading bots, automated arbitrage, and self-transfers, and a16z's [**$9 trillion**](https://a16zcrypto.com/posts/article/state-of-crypto-report-2025/) "adjusted" figure falls to roughly half of Visa's comparable **$10.2 trillion** — and genuine retail payments are a smaller fraction still. Most stablecoin movement is financial machinery, not the point of sale. The serious claim is narrower and more important: a dollar-settlement layer on the scale of a global card network now exists entirely outside the correspondent-banking system.

One intuition needs correcting. USDT leads on size, but not on use. In 2025 the order flipped: USDC settled about [**$18.3 trillion**](https://www.bloomberg.com/news/articles/2026-01-08/stablecoin-transactions-rose-to-record-33-trillion-led-by-usdc) against USDT's [**$13.3 trillion**](https://www.bloomberg.com/news/articles/2026-01-08/stablecoin-transactions-rose-to-record-33-trillion-led-by-usdc). The largest stock of dollar tokens and the busiest dollar rail are no longer the same instrument.

This is the paradox in a single line. The reserve dollar still commands [**56.77%**](https://data.imf.org/en/news/imf%20data%20brief%20march%2027) of allocated global reserves, and the dollar's grip on how value actually moves has, if anything, widened. But the channel has forked. The dollar is extending its reach by giving up its monopoly over the means through which dollar value travels. It is keeping the currency and losing the pipe — at once, in the same instrument.
...
Begin with the price, because it is not in dispute. Bitcoin trades near [**$63,700**](https://fortune.com/article/price-of-bitcoin-06-04-2026/) on June 4, 2026, down from about $73,000 at the start of the month and roughly $97,000 in January. Against its all-time high of about [**$126,000**](https://www.coingecko.com/en/coins/bitcoin), set on October 6, 2025, that is a drawdown of nearly **50%** — half the peak gone in eight months.

This is not a gentle correction. It is a broad repricing of a risk asset. Over the same stretch Bitcoin behaved like any leveraged growth trade in a risk-off market: U.S. spot Bitcoin ETFs posted their largest monthly outflows of the year, the asset [**underperformed other risk assets**](https://www.coindesk.com/daybook-us/2026/05/29/bitcoin-underperforms-risk-assets-as-record-9th-day-of-etf-outflows-signal-waning-demand) through a record run of redemptions, and its correlation with the S&P 500 climbed toward **0.7** — its highest since the 2023 banking stress. When equities catch cold, Bitcoin runs the fever. That is the signature of a beta asset, not a monetary refuge.
